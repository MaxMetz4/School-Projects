...
class FamilyTreeNodeTest2 {
	...
	void testFamilyTreeNode() {
		// setting up test cases
				...
				assertEquals(null, test.getLeft());
				assertEquals(null, test.getRight());
	}
	...
	@Test
	void testDoesFamilyMemberExist() {
		// setting up test cases
				FamilyTreeNode test = new FamilyTreeNode("Smith");
	...
	@Test
	void testAddFamilyMemberStringStringString() {
		// setting up test cases
				FamilyTreeNode test = new FamilyTreeNode("Smith");
...
//					assertThat(e.getMessage(), is("This person is already in the Family Tree."));
	...
	@Test
	void testGetPhoneNumberOfFamilyMember() {
		// setting test cases
				FamilyTreeNode test = new FamilyTreeNode("Smith");
